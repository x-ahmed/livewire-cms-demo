...
<body class="font-sans antialiased">
    ...
    <div class="min-h-screen bg-gray-100">
        ...
        <main>
            {{-- show notification --}}
            <div
                class="fixed top-0 right-0 px-5 py-3 mt-3 mr-3 text-white duration-700 transform bg-green-400 rounded-sm shadow-lg opacity-0 event-notification-box">
            </div>
            {{ $slot }}
            @livewire('chat')
        </main>
    ...
    @livewireScripts
    <script src="{{ asset('js/turbolinks.js') }}"
    ...
    {{-- Client Websocket Generator --}}
    <script src="{{ asset('js/socket.js') }}"></script>
    @stack('chat-websocket-client')
    <script>
